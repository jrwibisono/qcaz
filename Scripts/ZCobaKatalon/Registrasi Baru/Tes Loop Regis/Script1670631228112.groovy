...
for (int i = 0; i < 100; i++) {
	for(j=0;j<arrName.size();j++){
	    ...
	    WebUI.setText(findTestObject('ZCoba Katalon/Iklan - Landing Page (2)/Register/fieldNama'), arrName[j])
	
	    WebUI.setText(findTestObject('ZCoba Katalon/Iklan - Landing Page (2)/Register/fieldNoWhatsapp'), '085148991030')
	...
	for(j=0;j<noHp.size();j++){
		...
		WebUI.setText(findTestObject('ZCoba Katalon/Iklan - Landing Page (2)/Register/fieldNama'), 'noHp ni Bos')
	
		WebUI.setText(findTestObject('ZCoba Katalon/Iklan - Landing Page (2)/Register/fieldNoWhatsapp'), noHp[j])
	...
	for(j=0;j<email.size();j++){
		...
		WebUI.setText(findTestObject('ZCoba Katalon/Iklan - Landing Page (2)/Register/fieldEmail'), email[j])
	...
	for(j=0;j<password.size();j++){
		...
		WebUI.setText(findTestObject('ZCoba Katalon/Iklan - Landing Page (2)/Register/fieldPassword'), password[j])
	
		WebUI.setText(findTestObject('ZCoba Katalon/Iklan - Landing Page (2)/Register/fieldKonfirmasiPassword'), password[j])
