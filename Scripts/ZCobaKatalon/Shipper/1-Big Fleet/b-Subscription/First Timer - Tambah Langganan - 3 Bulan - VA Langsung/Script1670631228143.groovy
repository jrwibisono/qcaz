...
WebUI.clickImage(findTestObject('ZCoba Katalon/Shipper/Tambah Langganan/buttonBankBNI'))
...
WebUI.click(findTestObject('ZCoba Katalon/Shipper/Tambah Langganan/buttonOkHalamanPembayaran'))
