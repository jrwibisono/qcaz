...
WebUI.setText(findTestObject('ZCoba Katalon/Iklan - Landing Page (1)/Login/fieldEmailNoWhatsapp'), '081375696792')
...
String Text = WebUI.getText(findTestObject('ZCoba Katalon/Iklan - Landing Page (2)/Login/textNamaProfile'))
