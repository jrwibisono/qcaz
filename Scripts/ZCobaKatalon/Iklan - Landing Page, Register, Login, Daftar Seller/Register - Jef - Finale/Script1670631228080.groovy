...
// Uji No Hp ========================
Cetak = Cetak + loopingRegisterTest(Cetak, dataUji, errornya, 'noHp', arrNoHp, name, noHp, email, password, confPassword, refCode)
dataUji = ''
errornya = ''

// Uji Email ========================
Cetak = Cetak + loopingRegisterTest(Cetak, dataUji, errornya, 'email', arrEmail, name, noHp, email, password, confPassword, refCode)
dataUji = ''
errornya = ''

// Uji Password ========================
Cetak = Cetak + loopingRegisterTest(Cetak, dataUji, errornya, 'password', arrPassword, name, noHp, email, password, confPassword, refCode)
dataUji = ''
errornya = ''

// Uji Confirmation Password ========================
Cetak = Cetak + loopingRegisterTest(Cetak, dataUji, errornya, 'confPassword', arrConfPasswords, name, noHp, email, password, confPassword, refCode)
dataUji = ''
errornya = ''

// Uji Referral Code ========================
Cetak = Cetak + loopingRegisterTest(Cetak, dataUji, errornya, 'refCode', arrRefCode, name, noHp, email, password, confPassword, refCode)
dataUji = ''
errornya = ''
