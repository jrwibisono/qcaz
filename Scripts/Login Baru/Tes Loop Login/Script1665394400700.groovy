...
for (int i = 0; i < 50; i++) {
    for (j = 0; j < birds.size(); j++) {
        ...
        WebUI.setText(findTestObject('Login Baru/fieldEmailNoWhatsapp'), birds[j])

        WebUI.setText(findTestObject('Login Baru/fieldPassword'), 'Daniel123')

        WebUI.click(findTestObject('Login Baru/buttonMasuk'))
    ...
    for (j = 0; j < birds.size(); j++) {
        ...
        WebUI.setText(findTestObject('Registrasi Baru/fieldNama'), 'danielreynaldi@gmail.com')
