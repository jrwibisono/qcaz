...
Mobile.tap(findTestObject('Object Repository/Muatmuat - Apps/Seller/Human Capital/Lowongan Umum/Menu'), 0)

Mobile.tap(findTestObject('Object Repository/Muatmuat - Apps/Seller/Form Pasang Iklan/Step 1/Button Buat Iklan'), 0)

TestData data = findTestData("human_capital_lowongan_umum")

for (int i = 1; i <= data.getRowNumbers(); i++) {
	Mobile.callTestCase(findTestCase('Test Cases/Muatmuat - Apps/Seller/Global/Pasang Iklan/Step 1'), [:])
	
	Mobile.callTestCase(findTestCase('Test Cases/Muatmuat - Apps/Seller/Human Capital/Lowongan Umum/Pasang Iklan/Step 2'), [('data'): data, ('row'): i])
