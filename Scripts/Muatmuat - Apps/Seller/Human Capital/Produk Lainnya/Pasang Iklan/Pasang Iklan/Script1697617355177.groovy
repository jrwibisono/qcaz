...
TestData data = findTestData("human_capital_produk_lainnya")

for (int i = 1; i <= data.getRowNumbers(); i++) {
	Mobile.callTestCase(findTestCase('Test Cases/Muatmuat - Apps/Seller/Global/Pasang Iklan/Step 1'), [:])
	
	Mobile.callTestCase(findTestCase('Test Cases/Muatmuat - Apps/Seller/Human Capital/Produk Lainnya/Pasang Iklan/Step 2'), [('data'): data, ('row'): i])
