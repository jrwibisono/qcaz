...
Mobile.tap(findTestObject('Object Repository/Muatmuat - Apps/Seller/Form Pasang Iklan/Step 2/Dropdown/Jenis Karoseri Yang Dilayani/Button Lihat Semua'), 0)

Mobile.callTestCase(findTestCase('Test Cases/Muatmuat - Apps/Seller/Global/Pasang Iklan/Step 2/Section - Dropdown Jenis Karoseri Yang Dilayani'), [('jenisKaroseriYangDilayani'): data.getValue(6, row)])

Mobile.swipe(0, 1400, 0, 900)

Mobile.setText(findTestObject('Object Repository/Muatmuat - Apps/Seller/Form Pasang Iklan/Step 2/android.widget.EditText - Masukkan Kelebihan'), data.getValue(7, row), 60)
...
Mobile.callTestCase(findTestCase('Test Cases/Muatmuat - Apps/Seller/Global/Pasang Iklan/Step 2/Section - Dropdown Search'), [('text'): data.getValue(9, row)])
