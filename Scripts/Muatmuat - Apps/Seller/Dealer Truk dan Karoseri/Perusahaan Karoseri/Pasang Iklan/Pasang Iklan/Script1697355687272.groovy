...
Mobile.tap(findTestObject('Object Repository/Muatmuat - Apps/Seller/Dealer Truk dan Karoseri/Perusahaan Karoseri/Menu'), 0)

Mobile.tap(findTestObject('Object Repository/Muatmuat - Apps/Seller/Form Pasang Iklan/Step 1/Button Buat Iklan'), 0)

TestData data = findTestData("dealer_karoseri_karoseri")

for (int i = 1; i <= data.getRowNumbers(); i++) {
	Mobile.callTestCase(findTestCase('Test Cases/Muatmuat - Apps/Seller/Global/Pasang Iklan/Step 1'), [:])
	
	Mobile.callTestCase(findTestCase('Test Cases/Muatmuat - Apps/Seller/Dealer Truk dan Karoseri/Perusahaan Karoseri/Pasang Iklan/Step 2'), [('data'): data, ('row'): i])
