...
Mobile.tap(findTestObject('Object Repository/Muatmuat - Apps/Seller/Dealer Truk dan Karoseri/Produk Lainnya/Menu'), 0)

Mobile.tap(findTestObject('Object Repository/Muatmuat - Apps/Seller/Form Pasang Iklan/Step 1/Button Buat Iklan'), 0)

TestData data = findTestData("dealer_karoseri_produk_lainnya")

for (int i = 1; i <= data.getRowNumbers(); i++) {
	Mobile.callTestCase(findTestCase('Test Cases/Muatmuat - Apps/Seller/Global/Pasang Iklan/Step 1'), [:])
	
	Mobile.callTestCase(findTestCase('Test Cases/Muatmuat - Apps/Seller/Dealer Truk dan Karoseri/Produk Lainnya/Pasang Iklan/Step 2'), [('data'): data, ('row'): i])
