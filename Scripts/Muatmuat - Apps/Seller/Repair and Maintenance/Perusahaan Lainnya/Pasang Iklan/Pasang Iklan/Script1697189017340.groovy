...
Mobile.tap(findTestObject('Object Repository/Muatmuat - Apps/Seller/Repair and Maintenance/Perusahaan Lainnya/Menu'), 0)

Mobile.tap(findTestObject('Object Repository/Muatmuat - Apps/Seller/Form Pasang Iklan/Step 1/Button Buat Iklan'), 0)

TestData data = findTestData("repair_maintenance_perusahaan_lainnya")

for (int i = 1; i <= data.getRowNumbers(); i++) {
	Mobile.callTestCase(findTestCase('Test Cases/Muatmuat - Apps/Seller/Global/Pasang Iklan/Step 1'), [:])
	
	Mobile.callTestCase(findTestCase('Test Cases/Muatmuat - Apps/Seller/Repair and Maintenance/Perusahaan Lainnya/Pasang Iklan/Step 2'), [('data'): data, ('row'): i])
