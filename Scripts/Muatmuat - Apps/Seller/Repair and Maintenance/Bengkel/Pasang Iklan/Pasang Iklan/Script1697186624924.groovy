...
TestData data = findTestData("repair_maintenance_bengkel")

for (int i = 1; i <= data.getRowNumbers(); i++) {
	Mobile.callTestCase(findTestCase('Test Cases/Muatmuat - Apps/Seller/Global/Pasang Iklan/Step 1'), [:])
	
	Mobile.callTestCase(findTestCase('Test Cases/Muatmuat - Apps/Seller/Repair and Maintenance/Bengkel/Pasang Iklan/Step 2'), [('data'): data, ('row'): i])
