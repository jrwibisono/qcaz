...
Mobile.tap(findTestObject('Object Repository/Muatmuat - Apps/Shipper/Buyer/Intermodal Transportation/Menu Intermodal Transportation'), 0)

if (GlobalVariable.UserType == 1) {
	Mobile.tap(findTestObject('Object Repository/Muatmuat - Apps/Shipper/Buyer/Button Lewati'), 0)
}

Mobile.tap(findTestObject('Object Repository/Muatmuat - Apps/Shipper/Buyer/Intermodal Transportation/Menu Road Transportation'), 0)