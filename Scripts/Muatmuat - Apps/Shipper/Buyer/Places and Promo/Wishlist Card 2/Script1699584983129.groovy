...
Mobile.tap(findTestObject('Object Repository/Muatmuat - Apps/Shipper/Buyer/Places and Promo/Button Wishlist 2'), 0)
...
if (Mobile.verifyElementExist(findTestObject('Object Repository/Muatmuat - Apps/Shipper/Buyer/Text Detail'), GlobalVariable.Timeout, FailureHandling.OPTIONAL)) {
	Mobile.pressBack()
	Mobile.tap(findTestObject('Object Repository/Muatmuat - Apps/Shipper/Buyer/Places and Promo/Button Wishlist Index 2 2'), 0)
}
