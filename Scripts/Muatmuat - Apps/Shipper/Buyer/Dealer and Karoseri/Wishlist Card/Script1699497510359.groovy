...
Mobile.tap(findTestObject('Object Repository/Muatmuat - Apps/Shipper/Buyer/Dealer and Karoseri/Button Wishlist'), 0)
...
if (Mobile.verifyElementExist(findTestObject('Object Repository/Muatmuat - Apps/Shipper/Buyer/Text Detail'), GlobalVariable.Timeout, FailureHandling.OPTIONAL)) {
	Mobile.pressBack()
	Mobile.tap(findTestObject('Object Repository/Muatmuat - Apps/Shipper/Buyer/Dealer and Karoseri/Button Wishlist Index 2'), 0)
}
