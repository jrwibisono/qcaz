...
String inputSearchUser = 'asdasdasdasd'
...
String userDitemukan = WebUI.getText(findTestObject('0_MuatmuatJeff23Apr23/00_General/Page_Chat List  muatmuat/div_tidak_ditemukan_chat'))

int index = userDitemukan.indexOf(inputSearchUser)

if (index > -1) {
    hasilCekChat.add('V Berhasil Tidak Menemukan User')
} else {
    hasilCekChat.add('X Gagal Tidak Menemukan User')
}
