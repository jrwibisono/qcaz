...
if (titleNotif == 'Transport Market - Transporter') {
    hasilCekNotif.add('V Berhasil Masuk Halaman Notif TM Transporter')
} else {
    hasilCekNotif.add('X Gagal Masuk Halaman Notif TM Transporter')
}
