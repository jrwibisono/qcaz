...
if (titleNotif == 'Big Fleets - Transporter') {
    hasilCekNotif.add('V Berhasil Masuk Halaman Notif BF Transporter')
} else {
    hasilCekNotif.add('X Gagal Masuk Halaman Notif BF Transporter')
}
