...
WebUI.click(findTestObject('0_MuatmuatJeff23Apr23/00_General/Page_Notifikasi  muatmuat/div_TMTransporter'))
...
//boolean unreadPresent = WebUI.verifyElementPresent(findTestObject('0_MuatmuatJeff23Apr23/00_General/Page_Notifikasi  muatmuat/div_first_notifikasi'), 
...
if (index > -1) {
    hasilCekNotif.add('V Berhasil Ganti View Notif TM Transporter Belum Dibaca')
} else {
	...
	if (noNotifPresent) {
		...
		hasilCekNotif.add('X Gagal Ganti View Notif TM Transporter Belum Dibaca')
	}
}
