...
if (titleNotif == 'Transport Market - Shipper') {
    hasilCekNotif.add('V Berhasil Masuk Halaman Notif TM Shipper')
} else {
    hasilCekNotif.add('X Gagal Masuk Halaman Notif TM Shipper')
}
