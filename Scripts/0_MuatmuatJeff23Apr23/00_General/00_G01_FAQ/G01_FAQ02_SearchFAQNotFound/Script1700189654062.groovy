...
searchR1 = WebUI.getText(findTestObject('0_MuatmuatJeff23Apr23/00_General/Page_Pusat Bantuan  muatmuat/div_not_found'))

int index = searchR1.indexOf(searchQ)

if (index > -1) {
    hasilCekFAQ.add('V Search FAQ Tidak Ditemukan Benar')
} else {
    hasilCekFAQ.add('X Search FAQ Tidak Ditemukan Salah')
}
