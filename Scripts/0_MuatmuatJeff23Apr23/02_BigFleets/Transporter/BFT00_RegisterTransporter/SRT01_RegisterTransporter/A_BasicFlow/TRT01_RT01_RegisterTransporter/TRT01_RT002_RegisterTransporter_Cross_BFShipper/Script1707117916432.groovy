...
'Pilih Shipper'
WebUI.click(findTestObject('0_MuatmuatJeff23Apr23/00_RegisLogin/RL01_Login/A_BasicFlow/RL01_L03_LoginBFShipper/Page_Dashboard  muatmuat/div_Shipper'))

WebUI.click(findTestObject('0_MuatmuatJeff23Apr23/00_RegisLogin/RL01_Login/A_BasicFlow/RL01_L03_LoginBFShipper/Page_Dashboard  muatmuat/button_bergabung_sekarang_shipper'))

WebUI.click(findTestObject('0_MuatmuatJeff23Apr23/00_RegisLogin/RL01_Login/A_BasicFlow/RL01_L03_LoginBFShipper/Page_Dashboard  muatmuat/button_yakin_bergabung_shipper'))

WebUI.setText(findTestObject('0_MuatmuatJeff23Apr23/02_BigFleets/Shipper/BFS00_RegisterShipper/Page_DemoBigFleet  muatmuat/input_Anda belum mengisi jumlah pengiriman__d2eb24'), 
    '200')

WebUI.click(findTestObject('0_MuatmuatJeff23Apr23/00_RegisLogin/RL01_Login/A_BasicFlow/RL01_L03_LoginBFShipper/Page_Dashboard  muatmuat/button_kirim_shipper'))

WebUI.waitForPageLoad(60)

WebUI.callTestCase(findTestCase('0_MuatmuatJeff23Apr23/02_BigFleets/Shipper/BFS00_RegisterShipper/SRS01_RegisterShipper/C_AddOn/SRS01_AO01_BFS2'), 
    [('username') : username, ('noTelp') : noTelp, ('email') : email, ('password') : password], FailureHandling.CONTINUE_ON_FAILURE)

'Report WA'
not_run: WebUI.callTestCase(findTestCase('8_Test/ReportOtomasi'), [('reportText') : 'Cross Done - Berhasil Daftar BF Shipper -> Daftar BF Transporter'], 
    FailureHandling.CONTINUE_ON_FAILURE)
