...
WebUI.click(findTestObject('Page_Kontrak Harga  MuatMuat/button_Tab Menunggu Konfirmasi Anda'))

WebUI.click(findTestObject('Page_Kontrak Harga  MuatMuat/button_Sort_TabDaftarKontrakPenawaran'))

WebUI.click(findTestObject('Page_Kontrak Harga  MuatMuat/button_Sort_TabDaftarKontrakPenawaran_TanggalDibuat'))

WebUI.click(findTestObject('Page_Kontrak Harga  MuatMuat/button_Sort_TabDaftarKontrakPenawaran - Z-A'))
