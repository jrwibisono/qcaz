...
WebUI.click(findTestObject('Page_Kontrak Harga  MuatMuat/button_Tab Menunggu Konfirmasi Transporter'))

WebUI.click(findTestObject('Page_Kontrak Harga  MuatMuat/button_Detail Menunggu Konfirmasi Transporter'))
