...
WebUI.click(findTestObject('Page_Kontrak Harga  MuatMuat/button_Tab Riwayat'))

WebUI.click(findTestObject('Page_Kontrak Harga  MuatMuat/button_Tab Riwayat_Selesai'))

WebUI.click(findTestObject('Page_Kontrak Harga  MuatMuat/button_Detail Riwayat Selesai'))
