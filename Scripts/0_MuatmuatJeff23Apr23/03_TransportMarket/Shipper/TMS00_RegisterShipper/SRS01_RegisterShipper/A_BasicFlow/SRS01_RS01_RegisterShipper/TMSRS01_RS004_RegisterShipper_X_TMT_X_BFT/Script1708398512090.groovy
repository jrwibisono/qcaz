...
'Var Register'
String username = 'Vier Kal Tsit Drei und Zweizig'

String noTelp = '77704023'

String email = 'rckaltsit04023@yopmail.com'

String password = 'Az12345678'

String namaPerusahaan = 'PT. Vier Kal Tsit Drei und Zweizig'
...
WebUI.callTestCase(findTestCase('0_MuatmuatJeff23Apr23/02_BigFleets/Transporter/BFT00_RegisterTransporter/SRT01_RegisterTransporter/C_AddOn/SRT01_AO02_BFT3'), 
    [('username') : username, ('noTelp') : noTelp, ('email') : email, ('password') : password], FailureHandling.CONTINUE_ON_FAILURE)
