...
'Var Register'
String username = 'Sech Kal Tsit Sieben'

String noTelp = '77706007'

String email = 'rckaltsit06007@yopmail.com'

String password = 'Az12345678'

String namaPerusahaan = 'PT. Vier Kal Tsit Sieben'
...
WebUI.callTestCase(findTestCase('1_CSTicketingJeff01Jun23/02_Approve/02_04_Approve_Register_Seller'), [('namaPerusahaan') : namaPerusahaan], 
    FailureHandling.CONTINUE_ON_FAILURE)
