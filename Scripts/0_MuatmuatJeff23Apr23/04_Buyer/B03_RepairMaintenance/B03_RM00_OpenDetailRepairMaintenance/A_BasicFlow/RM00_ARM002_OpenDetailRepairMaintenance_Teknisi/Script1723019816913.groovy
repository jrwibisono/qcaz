...
WebUI.click(findTestObject('0_MuatmuatJeff23Apr23/04_Buyer/B03_RepairMaintenance/B03_RM02_Teknisi/Page_Repair  Maintenances Service  muatmuat.com/a_Teknisi'))
...
for (def row = 1; row <= findTestData('DataBuyer/B03_RM00_02_buyer_repair_maintenance_teknisi').getRowNumbers(); row++) {
    'Load Page - Awal Loop'
    WebUI.waitForPageLoad(60)
    ...
    WebUI.setText(findTestObject('Object Repository/0_MuatmuatJeff23Apr23/04_Buyer/B01_TransportationStore/B01_TS01_KendaraanKargo/Page_Transportation Store  muatmuat.com/input_Pencarian Terakhir_form-pencarian'), 
        findTestData('DataBuyer/B03_RM00_02_buyer_repair_maintenance_teknisi').getValue(12, row))
