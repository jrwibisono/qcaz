...
WebUI.click(findTestObject('0_MuatmuatJeff23Apr23/04_Buyer/B03_RepairMaintenance/B03_RM03_PerusahaanLainnya/Page_Repair  Maintenances Service  muatmuat.com/a_Lainnya'))

WebUI.waitForPageLoad(60)

WebUI.waitForJQueryLoad(60)

not_run: WebUI.click(findTestObject('0_MuatmuatJeff23Apr23/04_Buyer/B03_RepairMaintenance/B03_RM03_PerusahaanLainnya/Page_Repair  Maintenances Service  muatmuat.com/div_Perusahaan Lainnya'))

not_run: WebUI.waitForJQueryLoad(60)

'Loop Kendaraan Kargo'
for (def row = 1; row <= findTestData('DataBuyer/B03_RM00_04_buyer_repair_maintenance_produk_lainnya').getRowNumbers(); row++) {
    'Load Page - Awal Loop'
    WebUI.waitForPageLoad(60)
    ...
    WebUI.setText(findTestObject('Object Repository/0_MuatmuatJeff23Apr23/04_Buyer/B01_TransportationStore/B01_TS01_KendaraanKargo/Page_Transportation Store  muatmuat.com/input_Pencarian Terakhir_form-pencarian'), 
        findTestData('DataBuyer/B03_RM00_04_buyer_repair_maintenance_produk_lainnya').getValue(12, row))
