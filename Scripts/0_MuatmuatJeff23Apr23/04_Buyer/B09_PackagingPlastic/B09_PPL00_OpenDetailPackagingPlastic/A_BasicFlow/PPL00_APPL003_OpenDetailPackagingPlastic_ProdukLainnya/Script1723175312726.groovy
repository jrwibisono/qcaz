...
WebUI.click(findTestObject('0_MuatmuatJeff23Apr23/04_Buyer/B09_PackagingPlastic/Page_Packaging  Plastic  muatmuat.com/div_Produk Lainnya'))

WebUI.waitForJQueryLoad(60)

'Loop Kendaraan Kargo'
for (def row = 1; row <= findTestData('DataBuyer/B09_PPL00_03_buyer_plastic_packaging_produk_lainnya').getRowNumbers(); row++) {
    'Load Page - Awal Loop'
    WebUI.waitForPageLoad(60)
    ...
    WebUI.setText(findTestObject('Object Repository/0_MuatmuatJeff23Apr23/04_Buyer/B01_TransportationStore/B01_TS01_KendaraanKargo/Page_Transportation Store  muatmuat.com/input_Pencarian Terakhir_form-pencarian'), 
        findTestData('DataBuyer/B09_PPL00_03_buyer_plastic_packaging_produk_lainnya').getValue(12, row))
