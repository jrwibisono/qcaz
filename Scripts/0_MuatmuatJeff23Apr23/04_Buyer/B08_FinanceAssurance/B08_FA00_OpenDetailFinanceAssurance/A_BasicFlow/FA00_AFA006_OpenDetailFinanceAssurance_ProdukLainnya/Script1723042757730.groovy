...
WebUI.click(findTestObject('0_MuatmuatJeff23Apr23/04_Buyer/B08_FinanceAssurance/Page_Finance  Insurance  muatmuat.com/div_Produk Lainnya'))

WebUI.waitForJQueryLoad(60)

'Loop Kendaraan Kargo'
for (def row = 1; row <= findTestData('DataBuyer/B08_FA00_06_buyer_finance_assurance_produk_lainnya').getRowNumbers(); row++) {
    'Load Page - Awal Loop'
    WebUI.waitForPageLoad(60)
    ...
    WebUI.setText(findTestObject('Object Repository/0_MuatmuatJeff23Apr23/04_Buyer/B01_TransportationStore/B01_TS01_KendaraanKargo/Page_Transportation Store  muatmuat.com/input_Pencarian Terakhir_form-pencarian'), 
        findTestData('DataBuyer/B08_FA00_06_buyer_finance_assurance_produk_lainnya').getValue(12, row))
