...
WebUI.click(findTestObject('Object Repository/0_MuatmuatJeff23Apr23/04_Buyer/B08_FinanceAssurance/Page_Finance  Insurance  muatmuat.com/a_Bank'))
...
for (def row = 1; row <= findTestData('DataBuyer/B08_FA00_01_buyer_finance_assurance_bank').getRowNumbers(); row++) {
    'Load Page - Awal Loop'
    WebUI.waitForPageLoad(60)
    ...
    WebUI.setText(findTestObject('Object Repository/0_MuatmuatJeff23Apr23/04_Buyer/B01_TransportationStore/B01_TS01_KendaraanKargo/Page_Transportation Store  muatmuat.com/input_Pencarian Terakhir_form-pencarian'), 
        findTestData('DataBuyer/B08_FA00_01_buyer_finance_assurance_bank').getValue(12, row))
