...
WebUI.click(findTestObject('0_MuatmuatJeff23Apr23/04_Buyer/B02_PropertyWarehouse/B02_PW04_JasaPergudangan/Page_Property  Warehouse  muatmuat.com/a_Jasa Pergudangan'))
...
for (def row = 1; row <= findTestData('DataBuyer/B02_PW00_04_buyer_property_warehouse_jasa_pergudangan').getRowNumbers(); row++) {
    'Load Page - Awal Loop'
    WebUI.waitForPageLoad(60)
    ...
    WebUI.setText(findTestObject('Object Repository/0_MuatmuatJeff23Apr23/04_Buyer/B01_TransportationStore/B01_TS01_KendaraanKargo/Page_Transportation Store  muatmuat.com/input_Pencarian Terakhir_form-pencarian'), 
        findTestData('DataBuyer/B02_PW00_04_buyer_property_warehouse_jasa_pergudangan').getValue(12, row))
