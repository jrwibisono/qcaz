...
WebUI.click(findTestObject('0_MuatmuatJeff23Apr23/04_Buyer/B02_PropertyWarehouse/B02_PW02_GudangDisewakan/Page_Property  Warehouse  muatmuat.com/a_Gudang Disewakan'))
...
for (def row = 1; row <= findTestData('DataBuyer/B02_PW00_02_buyer_property_warehouse_gudang_disewakan').getRowNumbers(); row++) {
    'Load Page - Awal Loop'
    WebUI.waitForPageLoad(60)
    ...
    WebUI.setText(findTestObject('Object Repository/0_MuatmuatJeff23Apr23/04_Buyer/B01_TransportationStore/B01_TS01_KendaraanKargo/Page_Transportation Store  muatmuat.com/input_Pencarian Terakhir_form-pencarian'), 
        findTestData('DataBuyer/B02_PW00_02_buyer_property_warehouse_gudang_disewakan').getValue(12, row))
