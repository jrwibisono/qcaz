...
WebUI.click(findTestObject('0_MuatmuatJeff23Apr23/04_Buyer/B02_PropertyWarehouse/B02_PW05_PusatLogistikBerikat/Page_Property  Warehouse  muatmuat.com/a_Pusat Logistik Berikat'))
...
for (def row = 1; row <= findTestData('DataBuyer/B02_PW00_05_buyer_property_warehouse_pusat_logistik_berikat').getRowNumbers(); row++) {
    'Load Page - Awal Loop'
    WebUI.waitForPageLoad(60)
    ...
    WebUI.setText(findTestObject('Object Repository/0_MuatmuatJeff23Apr23/04_Buyer/B01_TransportationStore/B01_TS01_KendaraanKargo/Page_Transportation Store  muatmuat.com/input_Pencarian Terakhir_form-pencarian'), 
        findTestData('DataBuyer/B02_PW00_05_buyer_property_warehouse_pusat_logistik_berikat').getValue(12, row))
