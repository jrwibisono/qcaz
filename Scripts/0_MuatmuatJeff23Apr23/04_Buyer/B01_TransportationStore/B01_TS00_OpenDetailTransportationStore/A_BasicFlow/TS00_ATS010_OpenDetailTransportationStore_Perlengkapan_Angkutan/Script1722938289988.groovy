...
WebUI.click(findTestObject('0_MuatmuatJeff23Apr23/04_Buyer/B01_TransportationStore/B01_TS07_PerlengkapanAngkutan/Page_Transportation Store  muatmuat.com/a_Perlengkapan Angkutan'))
...
for (def row = 1; row <= findTestData('DataBuyer/TS01_10_buyer_transportation_store_perlengkapan_angkutan').getRowNumbers(); row++) {
    'Load Page - Awal Loop'
    WebUI.waitForPageLoad(60)
    ...
    WebUI.setText(findTestObject('Object Repository/0_MuatmuatJeff23Apr23/04_Buyer/B01_TransportationStore/B01_TS01_KendaraanKargo/Page_Transportation Store  muatmuat.com/input_Pencarian Terakhir_form-pencarian'), 
        findTestData('DataBuyer/TS01_10_buyer_transportation_store_perlengkapan_angkutan').getValue(12, row))
