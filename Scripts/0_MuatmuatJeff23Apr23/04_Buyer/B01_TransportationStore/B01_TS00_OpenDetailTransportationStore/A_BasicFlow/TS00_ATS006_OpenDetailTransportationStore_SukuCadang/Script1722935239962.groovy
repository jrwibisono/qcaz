...
WebUI.click(findTestObject('0_MuatmuatJeff23Apr23/04_Buyer/B01_TransportationStore/B01_TS04_SukuCadang/Page_Transportation Store  muatmuat.com/a_Suku Cadang'))
...
for (def row = 1; row <= findTestData('DataBuyer/TS01_06_buyer_transportation_store_suku_cadang').getRowNumbers(); row++) {
    'Load Page - Awal Loop'
    WebUI.waitForPageLoad(60)
    ...
    WebUI.setText(findTestObject('Object Repository/0_MuatmuatJeff23Apr23/04_Buyer/B01_TransportationStore/B01_TS01_KendaraanKargo/Page_Transportation Store  muatmuat.com/input_Pencarian Terakhir_form-pencarian'), 
        findTestData('DataBuyer/TS01_06_buyer_transportation_store_suku_cadang').getValue(12, row))
