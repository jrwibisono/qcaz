...
WebUI.click(findTestObject('0_MuatmuatJeff23Apr23/04_Buyer/B06_DealerKaroseri/B06_DK04_KatalogKaroseri/Page_Dealer Truk  Karoseri  muatmuat.com/a_Karoseri'))

WebUI.waitForPageLoad(60)

WebUI.waitForJQueryLoad(60)

WebUI.click(findTestObject('0_MuatmuatJeff23Apr23/04_Buyer/B06_DealerKaroseri/B06_DK04_KatalogKaroseri/Page_Dealer Truk  Karoseri  muatmuat.com/div_Katalog Produk Karoseri'))

WebUI.waitForJQueryLoad(60)

'Loop Kendaraan Kargo'
for (def row = 1; row <= findTestData('DataBuyer/B06_DK00_04_buyer_dealer_karoseri_katalog_karoseri').getRowNumbers(); row++) {
    'Load Page - Awal Loop'
    WebUI.waitForPageLoad(60)
    ...
    WebUI.setText(findTestObject('Object Repository/0_MuatmuatJeff23Apr23/04_Buyer/B01_TransportationStore/B01_TS01_KendaraanKargo/Page_Transportation Store  muatmuat.com/input_Pencarian Terakhir_form-pencarian'), 
        findTestData('DataBuyer/B06_DK00_04_buyer_dealer_karoseri_katalog_karoseri').getValue(12, row))
