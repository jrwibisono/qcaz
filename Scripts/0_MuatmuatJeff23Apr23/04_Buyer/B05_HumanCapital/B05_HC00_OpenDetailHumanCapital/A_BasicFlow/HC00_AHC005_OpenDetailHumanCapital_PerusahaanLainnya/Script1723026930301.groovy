...
WebUI.click(findTestObject('0_MuatmuatJeff23Apr23/04_Buyer/B05_HumanCapital/B05_HC01_LowonganProfesional/Page_muatmuat Website  muatmuat/div_Human CapitalCari lowongan dan pelamar _efa029'))

WebUI.waitForPageLoad(60)

WebUI.waitForJQueryLoad(60)

WebUI.click(findTestObject('0_MuatmuatJeff23Apr23/04_Buyer/B05_HumanCapital/B05_HC05_PerusahaanLainnya/Page_Human Capital  muatmuat.com/a_Lainnya'))

WebUI.waitForPageLoad(60)

WebUI.waitForJQueryLoad(60)

WebUI.click(findTestObject('0_MuatmuatJeff23Apr23/04_Buyer/B05_HumanCapital/B05_HC05_PerusahaanLainnya/Page_Human Capital  muatmuat.com/div_Perusahaan Lainnya'))

WebUI.waitForJQueryLoad(60)

'Loop Kendaraan Kargo'
for (def row = 1; row <= findTestData('DataBuyer/B05_HC00_05_buyer_human_capital_perusahaan_lainnya').getRowNumbers(); row++) {
    'Load Page - Awal Loop'
    WebUI.waitForPageLoad(60)
    ...
    WebUI.setText(findTestObject('Object Repository/0_MuatmuatJeff23Apr23/04_Buyer/B01_TransportationStore/B01_TS01_KendaraanKargo/Page_Transportation Store  muatmuat.com/input_Pencarian Terakhir_form-pencarian'), 
        findTestData('DataBuyer/B05_HC00_05_buyer_human_capital_perusahaan_lainnya').getValue(12, row))
