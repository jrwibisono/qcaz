...
WebUI.click(findTestObject('0_MuatmuatJeff23Apr23/04_Buyer/B05_HumanCapital/B05_HC04_HRConsultantTraining/Page_Human Capital  muatmuat.com/a_HR Consultant and Training'))
...
for (def row = 1; row <= findTestData('DataBuyer/B05_HC00_04_buyer_human_capital_hr_consultant_training').getRowNumbers(); row++) {
    'Load Page - Awal Loop'
    WebUI.waitForPageLoad(60)
    ...
    WebUI.setText(findTestObject('Object Repository/0_MuatmuatJeff23Apr23/04_Buyer/B01_TransportationStore/B01_TS01_KendaraanKargo/Page_Transportation Store  muatmuat.com/input_Pencarian Terakhir_form-pencarian'), 
        findTestData('DataBuyer/B05_HC00_04_buyer_human_capital_hr_consultant_training').getValue(12, row))
