...
WebUI.click(findTestObject('0_MuatmuatJeff23Apr23/04_Buyer/B04_IntermodalTransportation/B04_IT02_RailFreight/Page_Transportasi Intermoda  muatmuat.com/a_Rail Freight'))
...
for (def row = 1; row <= findTestData('DataBuyer/B04_IT00_02_buyer_intermodal_transportation_rail_freight').getRowNumbers(); row++) {
    'Load Page - Awal Loop'
    WebUI.waitForPageLoad(60)
    ...
    WebUI.setText(findTestObject('Object Repository/0_MuatmuatJeff23Apr23/04_Buyer/B01_TransportationStore/B01_TS01_KendaraanKargo/Page_Transportation Store  muatmuat.com/input_Pencarian Terakhir_form-pencarian'), 
        findTestData('DataBuyer/B04_IT00_02_buyer_intermodal_transportation_rail_freight').getValue(12, row))
