...
WebUI.click(findTestObject('0_MuatmuatJeff23Apr23/04_Buyer/B04_IntermodalTransportation/B04_IT01_IntermodalTrasnportation/Page_Transportasi Intermoda muatmuat.com/a_road_transportation'))
...
for (def row = 1; row <= findTestData('DataBuyer/B04_IT00_01_buyer_intermodal_transportation_road_transportation').getRowNumbers(); row++) {
    'Load Page - Awal Loop'
    WebUI.waitForPageLoad(60)
    ...
    WebUI.setText(findTestObject('Object Repository/0_MuatmuatJeff23Apr23/04_Buyer/B01_TransportationStore/B01_TS01_KendaraanKargo/Page_Transportation Store  muatmuat.com/input_Pencarian Terakhir_form-pencarian'), 
        findTestData('DataBuyer/B04_IT00_01_buyer_intermodal_transportation_road_transportation').getValue(12, row))
