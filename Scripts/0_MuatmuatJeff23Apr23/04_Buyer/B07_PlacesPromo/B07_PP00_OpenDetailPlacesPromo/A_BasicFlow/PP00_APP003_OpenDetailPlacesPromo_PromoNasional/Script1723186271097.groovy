...
WebUI.click(findTestObject('0_MuatmuatJeff23Apr23/04_Buyer/B07_PlacesPromo/B07_PP03_PromoNasional/Page_Places  Promo  muatmuat.com/a_Promo Nasional'))
...
for (def row = 1; row <= findTestData('DataBuyer/B07_PP00_03_buyer_places_promo_promo_nasional').getRowNumbers(); row++) {
    'Load Page - Awal Loop'
    WebUI.waitForPageLoad(60)
    ...
    WebUI.setText(findTestObject('Object Repository/0_MuatmuatJeff23Apr23/04_Buyer/B01_TransportationStore/B01_TS01_KendaraanKargo/Page_Transportation Store  muatmuat.com/input_Pencarian Terakhir_form-pencarian'), 
        findTestData('DataBuyer/B07_PP00_03_buyer_places_promo_promo_nasional').getValue(12, row))
