...
WebUI.click(findTestObject('0_MuatmuatJeff23Apr23/04_Buyer/B07_PlacesPromo/B07_PP02_PromoKotaKabupaten/Page_Places  Promo  muatmuat.com/a_Promo KotaKabupaten'))
...
for (def row = 1; row <= findTestData('DataBuyer/B07_PP00_02_buyer_places_promo_promo_kota').getRowNumbers(); row++) {
    'Load Page - Awal Loop'
    WebUI.waitForPageLoad(60)
    ...
    WebUI.setText(findTestObject('Object Repository/0_MuatmuatJeff23Apr23/04_Buyer/B01_TransportationStore/B01_TS01_KendaraanKargo/Page_Transportation Store  muatmuat.com/input_Pencarian Terakhir_form-pencarian'), 
        findTestData('DataBuyer/B07_PP00_02_buyer_places_promo_promo_kota').getValue(12, row))
