...
WebUI.click(findTestObject('0_MuatmuatJeff23Apr23/00_RegisLogin/RL02_Register/RL02_01_RegisterUser1/A_BasicFlow/R01_RU01_RegisterUser/Page_MuatMuatRegister  muatmuat/button_next_SK'))

String checkAlertClass = WebUI.getAttribute(findTestObject('0_MuatmuatJeff23Apr23/00_RegisLogin/RL02_Register/RL02_01_RegisterUser1/A_BasicFlow/R01_RU01_RegisterUser/Page_MuatMuatRegister  muatmuat/div_SK_Alert'), 
    'class')

int index = checkAlertClass.indexOf('d-none')

if (index > -1) {
    hasilCekRegister.add('X Alert SK Harus Check Gagal')
} else {
    hasilCekRegister.add('V Alert SK Harus Check Berhasil')
}
